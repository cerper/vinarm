...
const Header = () => {
  return (
    <div>
      <header className="fixed top-0 z-50 h-[140px] w-full max-w-[1920px] bg-vinarmBlack text-vinarmYellow transition-all lg:h-[102px]">
        <div className="container mx-auto h-full flex flex-col justify-between items-center lg:flex-row ">
          ...
          <MobileNav containerStyles="capitalize gap-4 fixed flex font-extrabold z-30 mt-28  md:text-xl lg:hidden" />
